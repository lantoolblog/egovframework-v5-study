...
CREATE MEMORY TABLE SAMPLE(ID VARCHAR(16) NOT NULL PRIMARY KEY,NAME VARCHAR(50),DESCRIPTION VARCHAR(200),USE_YN CHAR(1),REG_USER VARCHAR(10))
CREATE MEMORY TABLE IDS(TABLE_NAME VARCHAR(16) NOT NULL PRIMARY KEY,NEXT_ID DECIMAL(30) NOT NULL)

CREATE MEMORY TABLE BOARD(ID VARCHAR(36) NOT NULL PRIMARY KEY, TITLE VARCHAR(200) NOT NULL, CONTENT VARCHAR(10000), AUTHOR VARCHAR(100) NOT NULL, VIEW_COUNT INT DEFAULT 0)

INSERT INTO BOARD VALUES('SAMPLE-00001', 'AOP',           'Aspect Oriented Programming AOP',     '개발자 A',  10)
INSERT INTO BOARD VALUES('SAMPLE-00002', 'Logging',       '간편한 설정을 통해 로그를 저장하고 통제',       '개발자 B',  20)
INSERT INTO BOARD VALUES('SAMPLE-00003', 'IoC Container', 'Inversion of Control Container',      '개발자 C',  5)
INSERT INTO BOARD VALUES('SAMPLE-00004', 'ID Generation', '시스템에서 사용하는 ID(Identifier)를 생성',  '개발자 D',  15)
INSERT INTO BOARD VALUES('SAMPLE-00005', 'Transaction',   'Database Transaction 처리 방법',         '개발자 E',  30)
