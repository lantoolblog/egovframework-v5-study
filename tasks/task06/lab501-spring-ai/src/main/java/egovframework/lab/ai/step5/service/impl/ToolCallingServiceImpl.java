 ...
 *
 * <p>ChatClient에 Tool 인스턴스를 등록하면 AI가 필요 시 해당 Tool을 호출한다.<br>
...
public class ToolCallingServiceImpl implements ToolCallingService {
  ...
  public String askDateTime(String question) {
    ...
    // <p>
    // .tools(Object... toolObjects) 에 Tool이 정의된 객체 인스턴스를 전달한다.<br>
  ...
  public String askDayOfWeek(String question) {
    // TODO Step 5-2: askDateTime()과 동일한 방식으로 작성하도록 한다. <br>
    //               동일한 dateTimeTools 인스턴스를 사용. <br>
