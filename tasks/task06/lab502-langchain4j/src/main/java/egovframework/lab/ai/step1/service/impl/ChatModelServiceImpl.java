 ...
 *
 * <p>ChatModel은 LangChain4jConfig에서 @Bean으로 등록한 Bean.<br>
...
public class ChatModelServiceImpl implements ChatModelService {
  ...
  public Integer getTotalTokens(String message) {
    ...
    ChatResponse response = chatWithUserMessage(message);
    // Spring AI: response.getMetadata().getUsage().getTotalTokens()
